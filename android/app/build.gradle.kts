...
android {
    namespace = "dev.abdulkhalek.statushelper"
    ...
    defaultConfig {
        applicationId = "dev.abdulkhalek.statushelper"
    ...
    buildTypes {
        release {
            // Use the release signing config when key.properties exists, else
            // fall back to debug keys so a plain `flutter run --release` still works.
